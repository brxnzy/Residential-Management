document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (showMoreBtn) {
          const additionalClaims = document.querySelectorAll('.additional-claim');
          showMoreBtn.addEventListener('click', () => {
            const isHidden = additionalClaims[0].classList.contains('hidden');
            additionalClaims.forEach(claim => claim.classList.toggle('hidden', !isHidden));
